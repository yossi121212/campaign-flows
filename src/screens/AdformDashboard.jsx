            ...
            <div style={{ padding: '0 2rem' }}>
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <span style={{ fontSize: '0.9rem', color: '#1e40af', marginLeft: '0.5rem' }}>
                            Data is still warming up - small fluctuations are normal as attribution and the ad platform begin optimizing.
                        </span>
                    </div>
                    <X size={16} color="#64748b" style={{ cursor: 'pointer', flexShrink: 0 }} />
                </div>
